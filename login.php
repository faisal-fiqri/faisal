...
<body>
    ...
    <div class="flex items-center justify-center" style="margin: 50px 0;">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
            <center>
                <h1 class="block text-grey-darker text-sm font-bold" style="margin-top: 10px; margin-bottom: 40px; font-size: 30px;">Masuk</h1>
            </center>
            <form action="login-action.php" method="post" >
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="email" type="email" name="email" placeholder="nama@gmail.com">
                </div>
                <div class="mb-6">
                    ...
                    <p class="text-red text-xs italic">Masukkan Password.</p>
                </div>
                <div class="flex items-center justify-between">
                    <button class="bg-primary hover:bg-secondary text-white font-bold py-2 px-4 rounded" type="submit">
                        Masuk
                    </button>
                    <a href="register.php">
                        <u>Daftar</u>
