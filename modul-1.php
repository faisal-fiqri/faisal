            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link active" aria-current="page" href="modul.php">Modul</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-light">
        <div class="container">
            ...
            <div class="container-video">
                <iframe width="100%" height="500" src="https://www.usd.ac.id/fakultas/pendidikan/f1l3/PLPG2017/Download/materi/ipa/BAB-II_-KLASIFIKASI-MAKHLUK-HIDUP.pdf"></iframe>
            <br><br>
